    ...
    <table>
        ...
        <thead>
            ...
            <tr>
                ...
                <td>{{ $invoices['Made'] }}</td>
                <td>Name:</td>
                <td>{{ $invoices['Delegate'] }}</td>
            </tr>
            <tr>
                <td>ID:</td>
                <td>{{$invoices['ID_made']}}</td>
                <td>ID:</td>
                <td>{{$invoices['ID_delegate']}}</td>
            </tr>
            <tr>
                <td>Email:</td>
                <td>{{$invoices['email_made']}}</td>
                <td>Email:</td>
                <td> {{$invoices['email_delegate']}}</td>
            </tr>
            <tr>
                <td>Phone:</td>
                <td>{{$invoices['phone']}}</td>
                <td>Phone:</td>
                <td> {{$invoices['phone_delegate']}}</td>
            </tr>
            <tr>
